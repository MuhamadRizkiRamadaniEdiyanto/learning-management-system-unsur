        ...
        <div class="mt-4">
            ...
            <div class="mt-2 flex gap-4">
                <label class="flex items-center">
                    <input type="radio" name="role" value="mahasiswa" x-model="role" class="rounded-full"
                        required />
                    <span class="ms-2 text-sm text-gray-700">{{ __('Mahasiswa') }}</span>
                </label>
                <label class="flex items-center">
                    <input type="radio" name="role" value="dosen" x-model="role" class="rounded-full" required />
                    <span class="ms-2 text-sm text-gray-700">{{ __('Dosen') }}</span>
                </label>
            </div>
