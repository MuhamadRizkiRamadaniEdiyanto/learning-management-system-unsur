        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.mahasiswa.update', $mahasiswa) }}"
                ...
                <div><x-input-label for="name" value="Nama Mahasiswa" /><x-text-input id="name" name="name"
                        class="mt-1 block w-full" value="{{ old('name', $mahasiswa->name) }}" required
                ...
                <div><x-input-label for="email" value="Email" /><x-text-input id="email" name="email"
                        type="email" class="mt-1 block w-full" value="{{ old('email', $mahasiswa->email) }}"
                ...
                <div><x-input-label for="nomor_induk" value="NIM" /><x-text-input id="nomor_induk" name="nomor_induk"
                        class="mt-1 block w-full" value="{{ old('nomor_induk', $mahasiswa->nomor_induk) }}"
